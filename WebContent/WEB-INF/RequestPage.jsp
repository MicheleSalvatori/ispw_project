			...
			<div style="width: 60%; margin-right: 5vw; float: left; height: 80vh;">
				...
				<div style="border: 2px solid #0C0B0B; border-radius: 14px; width: 100%; height: 100%;">
					<table id="tableRequest" style="border-collapse: separate; border-spacing: 0 10px; width: 100%; border: 15px solid transparent;">
						...
						<tr>
							<td colspan="4" class="request-text" align="center">
								No request found.
							</td>
						</tr>
						</c:if>	
						<c:forEach items="${listOfRequest}" var="request">
						<tr height="60px" class="request">
							<td class="request-text" style="border-radius: 14px 0 0 14px; white-space: nowrap; padding: 1vw;">
								${request.getStudent().getName()} ${request.getStudent().getSurname()}
							</td>
