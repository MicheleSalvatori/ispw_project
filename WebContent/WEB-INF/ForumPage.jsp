					...
					<td style="padding-bottom: 20px;" align="center">
						...
						%> <a href="/ispw_project/ExamPageServlet">
							<button class="nav-button" type="button" name="exam">
								<svg class="nav-icon" width="31" height="27" viewBox="0 0 31 27"
									fill="none" xmlns="http://www.w3.org/2000/svg">
								<path
...
<div class="content">
								...
								<tr>
									<c:choose>
										<c:when test="${question.isSolved()}">
											<td style="padding: 0; color: green;" class="question-solved">Solved</td>
										</c:when>
										<c:otherwise>
	...
	<div class="content-assignment" width="50%"
		style="height: 100%; border: 2px solid #0C0B0B; border-radius: 14px;">
		<table
			style="border-collapse: separate; border-spacing: 0; width: 50%; border: 15px solid transparent;">
			<tbody style="overflow: auto; display: block;">
