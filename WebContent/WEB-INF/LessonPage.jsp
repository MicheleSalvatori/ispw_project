		...
		<div class="content row">
			...
			<div style="float: left; width: 45%; margin-right: 5vw;" class="col">
				...
				<div class="info">
					<table style="width: 100%;">
						...
						<tr>
							...
							<td class="secondary-info" style="text-align: right;">
								m
							</td>
						</tr>
						...
						<tr>
							...
							<td class="secondary-info" style="text-align: right; padding-bottom: 0.5vw;">
								c
							</td>
						</tr>
					</table>
						...
						<table style="width: 100%; height: 100%;">
							<tr>
								<td style="text-align: right; width: 50%;">
									<img class="time-img" src="Time.png" alt="time" style="padding-right: 2vw;">
								</td>
							...
							<tr>
								<td style="text-align: right;">
									<img class="time-img" src="Date.png" alt="date" style="padding-right: 2vw;">
								</td>
				...
				<div style="margin-top: 25px; width: 98%;">
					<a class="text" style="padding-left: 0;">Lesson Topic</a>
					<br>
					<textarea style="height: 40vh;" class="text-area" readonly>mhanz</textarea>
				</div>
			...
			<div style="float: right; width: 50%;" class="col">
				...
				<div class="seat">
					<table style="border-spacing: 10px;">
						<tr>
							<td>
								<button class="button-seat seat-free">
									1
								</button>
							</td>
							
							<td>
								<button class="button-seat seat-booked">
									2
								</button>
							</td>
							
							<td class="secondary-text" style="padding: 0;">
								A
							</td>
						</tr>
						...
						<tr>
							<td>
								<button class="button-seat seat-your">
									1
								</button>
							</td>
							
							<td>
								<button class="button-seat" disabled>
									2
								</button>
							</td>
