...
<body>
					...
					<tr>
						<td valign="top" style="padding-bottom: 20px;" align="center">
							<a href="/ispw_project/HomePageServlet" class="nav-button"type="button">
								<svg class="nav-icon" width="27" height="26" viewBox="0 0 27 26" fill="white" xmlns="http://www.w3.org/2000/svg">
 ...
 %>
					...
					<tr>
						<td style="padding-bottom: 20px;" align="center"><a
							href="/ispw_project/ProfilePageServlet" class="nav-button"
							type="button"> <svg class="nav-icon" width="26" height="32"
