	...
	<body>
		...
		<div class="content">
			<table style="width: 100%">
				...
				<tr>
					<td width="30%;">
						<input class="text-input" type="text" placeholder="Title" style="padding-left: 5px; width: 100%; height: 40px;">
					</td>
					
					<td style="text-align: left; padding-left: 2vw;">
						<input class="datepicker-input" type="date" style="width: 80%; height: 40px;">
					</td>
				...
				<tr>
					<td colspan="3" style="text-align: center; padding-top: 25px;">
						<textarea style="width: 99%; height: 50vh;" class="input-text" placeholder="Description"></textarea>
					</td>
				</tr>
