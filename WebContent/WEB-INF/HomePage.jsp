				...
				<tbody>
					...
					<tr>
						<td valign="top" style="padding-bottom: 20px;" align="center">
							<button class="nav-button" type="button" name="home">
								<svg class="nav-icon" width="27" height="26" viewBox="0 0 27 26"
					...
					<tr>
						<td style="padding-bottom: 20px;" align="center">
							...
							%> <a href="/ispw_project/ExamPageServlet">
								<button class="nav-button" type="button" name="exam">
									<svg class="nav-icon" width="31" height="27"
					...
					<tr>
						<td style="padding-bottom: 20px;" align="center">
							<button class="nav-button" type="button" name="profile">
								<svg class="nav-icon" width="26" height="32" viewBox="0 0 26 32"
									fill="none" xmlns="http://www.w3.org/2000/svg">
								<path
										d="M5.8 8C5.8 4.14822 8.94822 1 12.8 1C16.6518 1 19.8 4.14822 19.8 8C19.8 11.8518 16.6518 15 12.8 15C8.94822 15 5.8 11.8518 5.8 8ZM1 22.8C1 21.3783 2.17828 20.2 3.6 20.2H22C23.4217 20.2 24.6 21.3783 24.6 22.8V23.7594C24.6 25.6597 23.3904 27.4941 21.2951 28.8303C19.2095 30.1603 16.2915 31 12.8 31C9.30855 31 6.39049 30.1603 4.30487 28.8303C2.20957 27.4941 1 25.6597 1 23.7594V22.8Z"
										stroke="white" stroke-width="2" />
							</svg>
							</button>
						</td>
					...
					<tr>
						<td style="padding-bottom: 20px;" align="center">
							<button class="nav-button" type="button" name="news">
								<svg class="nav-icon" width="27" height="22" viewBox="0 0 27 22"
									fill="none" xmlns="http://www.w3.org/2000/svg">
								<path
										d="M22.6717 5.03109L21.9937 4.95841V4.25C21.9937 2.41389 20.4441 1 18.6366 1H5.01754C3.21004 1 1.6604 2.41389 1.6604 4.25V16.75C1.6604 19.1376 3.67989 21 6.06516 21H21.2556C23.6409 21 25.6604 19.1376 25.6604 16.75V8.25C25.6604 6.53348 24.3035 5.206 22.6717 5.03109Z"
										stroke="white" stroke-width="2" />
							</svg>
							</button>
						</td>
						...
						<td style="padding-bottom: 20px;" align="center">
							...
							<button class="nav-button" type="button" name="schedule">
								<svg class="nav-icon" width="32" height="31" viewBox="0 0 32 31"
									fill="none" xmlns="http://www.w3.org/2000/svg">
								<path
										d="M21.3271 2.58333H23.9104V6.45833H21.3271V2.58333ZM8.4104 15.5C4.1479 15.5 0.6604 12.0125 0.6604 7.75C0.6604 3.4875 4.1479 0 8.4104 0C12.6729 0 16.1604 3.4875 16.1604 7.75C16.1604 12.0125 12.6729 15.5 8.4104 15.5ZM8.4104 2.58333C5.56873 2.58333 3.24373 4.90833 3.24373 7.75C3.24373 10.5917 5.56873 12.9167 8.4104 12.9167C11.2521 12.9167 13.5771 10.5917 13.5771 7.75C13.5771 4.90833 11.2521 2.58333 8.4104 2.58333ZM11.3812 9.42917L9.44373 7.62083L10.9937 4.90833L9.5729 4.13333L7.37707 7.87917L10.2187 10.7208L11.3812 9.42917Z"
										fill="white" />
								<path
										d="M25.2021 5.16663H18.4053C18.6184 5.99329 18.7437 6.85613 18.7437 7.74996H25.2021V10.3333H18.4053C18.1689 11.2504 17.8137 12.1171 17.35 12.9166H25.2021L25.2034 25.8333H7.11873V17.9942C6.21586 17.8818 5.35044 17.6558 4.5354 17.3251V25.8333C4.5354 27.258 5.69403 28.4166 7.11873 28.4166H25.2021C26.6268 28.4166 27.7854 27.258 27.7854 25.8333V7.74996C27.7854 6.32525 26.6268 5.16663 25.2021 5.16663Z"
										fill="white" />
							</svg>
							</button> <%
 }
					...
					<td style="padding-right: 10px;">
						<button class="status-button" type="button" name="notification">
							<svg width="24" height="26" viewBox="0 0 24 26" fill="none"
								xmlns="http://www.w3.org/2000/svg">
								<path
									d="M23.0209 11.6458C22.5724 11.6458 22.2084 11.2818 22.2084 10.8333C22.2084 7.72192 20.9974 4.79803 18.7981 2.59778C18.4807 2.2804 18.4807 1.76584 18.7981 1.44846C19.1155 1.13107 19.63 1.13107 19.9476 1.44846C22.4534 3.95519 23.8334 7.2887 23.8334 10.8333C23.8334 11.2818 23.4694 11.6458 23.0209 11.6458Z"
									fill="#0C0B0B" />
								<path
									d="M0.8125 11.6458C0.363998 11.6458 0 11.2818 0 10.8333C0 7.28868 1.38022 3.95517 3.88695 1.44943C4.20433 1.13205 4.71909 1.13205 5.03647 1.44943C5.35385 1.76682 5.35385 2.28157 5.03647 2.59895C2.83621 4.79802 1.625 7.72191 1.625 10.8333C1.625 11.2818 1.261 11.6458 0.8125 11.6458Z"
									fill="#0C0B0B" />
								<path
									d="M11.9165 26C9.67618 26 7.854 24.1778 7.854 21.9375C7.854 21.489 8.218 21.125 8.6665 21.125C9.11501 21.125 9.479 21.489 9.479 21.9375C9.479 23.282 10.572 24.375 11.9165 24.375C13.2608 24.375 14.354 23.282 14.354 21.9375C14.354 21.489 14.718 21.125 15.1665 21.125C15.615 21.125 15.979 21.489 15.979 21.9375C15.979 24.1778 14.1568 26 11.9165 26Z"
									fill="#0C0B0B" />
								<path
									d="M20.8542 22.75H2.97922C1.93364 22.75 1.08325 21.8996 1.08325 20.8542C1.08325 20.2994 1.32486 19.7741 1.74638 19.4133C3.394 18.0212 4.33325 15.9977 4.33325 13.8538V10.8333C4.33325 6.65175 7.735 3.25 11.9167 3.25C16.0982 3.25 19.5 6.65175 19.5 10.8333V13.8538C19.5 15.9977 20.4392 18.0212 22.0761 19.4058C22.5084 19.7741 22.75 20.2994 22.75 20.8542C22.75 21.8996 21.8996 22.75 20.8542 22.75ZM11.9167 4.875C8.63081 4.875 5.95825 7.54756 5.95825 10.8333V13.8538C5.95825 16.4763 4.80893 18.9529 2.80585 20.6461C2.76796 20.6787 2.70825 20.7459 2.70825 20.8542C2.70825 21.0014 2.83183 21.125 2.97922 21.125H20.8542C21.0014 21.125 21.125 21.0014 21.125 20.8542C21.125 20.7459 21.0655 20.6787 21.0296 20.6483C19.0243 18.9529 17.875 16.4763 17.875 13.8538V10.8333C17.875 7.54756 15.2024 4.875 11.9167 4.875Z"
									fill="#0C0B0B" />
								<path
									d="M11.9165 4.875C11.468 4.875 11.104 4.511 11.104 4.0625V0.8125C11.104 0.363998 11.468 0 11.9165 0C12.365 0 12.729 0.363998 12.729 0.8125V4.0625C12.729 4.511 12.365 4.875 11.9165 4.875Z"
									fill="#0C0B0B" />
							</svg>
						</button>
					</td>

					<td style="padding-right: 10px;"><input class="status-avatar"
						type="image" src="res/img/Logo.png" alt="avatar" /></td>
	...
	<div class="content">
		...
		<div class="row">
			...
			<div class="hello col" id="hello">
				<table>
					<tr>
						<td class="hello-text">Hello nome!</td>
					</tr>

					<tr>
						<td class="hello-sub">It's good to see you again.</td>
					</tr>
				</table>
			</div>
			...
			<div class="stat col">
				<table style="border-collapse: collapse;" align="center">
					<tr>
						<td class="stat-num">25</td>

						<td class="stat-text">New<br>Questions
						</td>
					</tr>
				</table>
			</div>
		...
		<div style="padding-top: 2vw;">
			...
			<div class="col" style="float: left; width: 47%; margin-right: 5vw;">
						...
						<tr>
							...
							<td style="vertical-align: middle;" align="left">
								<table style="display: inline; vertical-align: middle;"
									spacing="0">
									<tr>
										<td class="lesson-text"><%=lesson.getCourse().getAbbrevation()%>
										</td>
									</tr>

									<tr>
										<td style="padding-top: 0;" class="lesson-classroom"><%=lesson.getClassroom().getName()%>
										</td>
									</tr>
								</table> <br>
							...
							<td align="right"><img class="time-img"
								src="res/img/Time.png" alt="time"></td>

							<td
								style="vertical-align: middle; padding-left: 0.5vw; white-space: nowrap; width: 1%;"
								class="lesson-time"><label
								style="display: inline; vertical-align: middle;"> <%=SQLConverter.time(lesson.getTime())%>
							</label></td>
				...
				<div style="padding-top: 2vw; width: 100%;">
					<table
						style="border-collapse: separate; width: 100%; border-spacing: 0 15px;">
						...
						<tbody style="overflow: auto; display: block;">
							<c:forEach items="${listOfLesson}" var="lesson">
								<tr class="lesson">
									<td
										style="padding: 1vw; white-space: nowrap; width: 50px; border-radius: 14px 0 0 14px;">
										<img class="img" src="res/img/Lesson.png" alt="lesson">
									</td>
										...
										<table style="display: inline; vertical-align: middle;"
											...
											<tr>
												<td class="lesson-text">
													${lesson.getCourse().getAbbrevation()}</td>
											</tr>

											<tr>
												<td style="padding-top: 0;" class="lesson-classroom">
													${lesson.getClassroom().getName()}</td>
											</tr>
										</table> <br>
									...
									<td
										...
										style="display: inline; vertical-align: middle;">
											${SQLConverter.time(lesson.getTime())} </label></td>

									<td align="right"
										style="padding: 0 1vw 0 1vw; white-space: nowrap; width: 1%; border-radius: 0 14px 14px 0;">
										<button class="button-view" type="button">View</button>
									</td>
								</tr>
							</c:forEach>
							...
							<c:forEach items="${listOfLesson}" var="mhanz">
								<td style="padding-right: 1vw; width: 20%;">
									<table class="weather" align="center">
										<tr>
											<td class="weather-text">15 °C</td>
										</tr>

										<tr>
											<td align="center"><img class="img" src="Cloud.png"
												alt="weath"></td>
										</tr>

										<tr>
											<td class="weather-text">10:00</td>
										</tr>
									</table>
								</td>
							</c:forEach>
